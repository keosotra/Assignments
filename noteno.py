...
test = yf.download("GDX, GLD, GDXJ, GOLD, NEM,FNV,AEM, RGLD,KL,BTG, AUY, WPM, KGC, AU, NUGT, JNUG, SIL, SLV, AG, HL, PAAS, CDE, FSM, GPL, SILJ, AXU, USAS, ^VIX, SPY, QQQ, VTI, IWM", period='60d', interval='2m')
len(test)
...
test_x, test_y = preprocess_input(main_df)
...
classes = new_model.predict(test_x, batch_size=64)
classes
